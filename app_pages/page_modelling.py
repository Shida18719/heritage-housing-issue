...
def page5_modelling_and_evaluation():
    ...
    st.info(
        ...
        f"* We knew that a **Regressor Model** would be suitable for predicting "
        f" the **Sale Price** of the houses since our **target** is a continous variable.\n "
        f"* We have completed a series of steps used for **Supervised Learning** "
        f" and following the **CRISP-DM** workflow.\n "
        f"* We have carefully considered the following steps after spliting "
        ...
        f" configured the hyperparameter for optimazation and using fewer "
        f" variables to deliver equivalent result. \n"
    ...
    st.info("* We compared the predicted price to the actual price values in the plots shown below.\n "
            "* The plots that Predict y and x Actual plot, tend to follow the actual value(the red diagonal line),"
            " which indicate predicted price is equals to the actual price.\n"
            "* Where the prediction data point equals to actual value is just slightly above $400000.\n"
            "* The model may not predict prices well above $425000 accurately, "
            " as the data points spread indicates greater variability and below the red line.\n\n "
