...
def page3_hypothesis_and_validation():
    ...
    st.info(
        ...
        f" allowing us draw a conclusions about the hypothesis"
        f" based on the results obtained.\n\n"
        f" Below is the **Process** and **Validation** "
        f" as to how these conlusions were achieved : \n\n"
    )
    ...
    st.success(
        ...
        f" high qualty rating of the material and finish of the house "
        f" has a relatively high correlation to the house sale price.\n "
        ...
        f" We assume there might be other factors that could be attributed to price rise."
        f" This would make a good case for further investigations. \n"
        ...
        f" shows the houses with higher rating of overall quality generally"
        f" correlates with a higher selling price."
